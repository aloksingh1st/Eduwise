...
export default function EduviShopOne({img="images/defaultNoData.png", thethree = "The Three Musketeers", price = "$40.00", ...props }) {
  return (
    <div {...props}>
      <div className="flex flex-col items-center justify-start w-full p-5 bg-white-A700 rounded-[10px]">
        <div className="flex flex-col items-center justify-start w-full max-w-[230px]">
          <Img src={img} alt="image" className="w-full object-cover rounded-[10px]" />
        </div>
      </div>
